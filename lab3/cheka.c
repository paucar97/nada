...
//El sizeof(Header) va a salir 2 en términos de Align ya que header mide 16 y align mide 8 (tamaño del long)
...
if ((p->s.size >= nunits) && (nunits + 1 != p->s.size)) {  /* big enough */
