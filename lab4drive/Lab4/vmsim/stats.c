...
void stats_output() {
  ...
  fprintf(o, "    %*d, %*d,  %s,  %*s,  %*ld\n",10, opts.phys_pages,8, opts.pagesize, (opts.input_file ? opts.input_file : "stdin"),13, opts.fault_handler->name,9, opts.limit);
...
void stats_output_type(FILE* o, type_count_t output, const char *label) {
  fprintf(o, "\t%s %*u, %*u, %*u;  %*u\n",label,
    4,output[REF_KIND_CODE],
 4,output[REF_KIND_LOAD],
    5,output[REF_KIND_STORE],
 6,output[REF_KIND_CODE]+ output[REF_KIND_LOAD]+ output[REF_KIND_STORE]);
}